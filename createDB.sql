...
create table login(username varchar(255), pass varchar(255), id int NOT NULL, CONSTRAINT login_pk PRIMARY KEY (id));
...
INSERT INTO login VALUES ("testUser", "password", 123456);
