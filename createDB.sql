...
create table favorites(username varchar(255), appid int NOT NULL, CONSTRAINT fav_pk PRIMARY KEY (username), FOREIGN KEY (username) REFERENCES userInfo(username));
